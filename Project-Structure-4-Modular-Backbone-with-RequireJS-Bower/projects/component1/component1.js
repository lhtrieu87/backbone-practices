...
;
define("scripts/models", function(){});

define('tpl',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});

define('tpl!scripts/views/layout/view1.html', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<span>This is View1</span>');}return __p.join('');}});

define('scripts/views/View1',['jquery', 'underscore', 'backbone', 'tpl!./layout/view1.html'], function($, _, Backbone, template) {
...
define('scripts/views',['./views/View1'], function(View1) {
	var Views = {
		View1: View1
	};
