...
// Generated on 2014-05-17 using generator-backbone-module 1.0.0
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    copy: {
      dist: {
        files: [
          {src: ['contact-manager.js'], dest: './', cwd:'lib/', expand: true}
        ]
      }
    },
    uglify: {
      dist: {
        files: {
          'contact-manager.min.js': ['lib/contact-manager.js']
        }
      }
    },
    connect: {
